...
/**
 * Sensor — IoT sensor associated with a room.
 *
 * Supported protocols:
 *   - mqtt: sensor publishes to topic cannas/{tenantId}/{sensorId}/reading
 *   - rest: sensor sends HTTP POST requests to /api/sensors/{id}/reading
 *   - simulated: data generated by the scripts/simulate_sensors.py script
 *
 * SensorReadings are stored in a separate TimescaleDB table
 * (not a standard Doctrine entity — queries via native DBAL for performance).
 *
 * Thresholds (alert thresholds) JSON format:
 * {
 *   "min": 18.0,
 *   "max": 28.0,
 *   "unit": "°C",
