...
> **Portage sur main `869e592` :** ce document conserve les constats et résultats
> de la base initiale `58081ea`. Le HMAC, les contrôles récents et PHPStan niveau 6
> de main sont conservés dans la PR. Les résultats actualisés du portage figurent
> dans [PR — intégration sur main](pr-integration.md) ; les anciens chiffres ne
> constituent pas une qualification de la nouvelle base.
